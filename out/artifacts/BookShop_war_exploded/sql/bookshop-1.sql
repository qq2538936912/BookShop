...
(1,1,'小故事大道理大全集','雅琴',36,100,200,'/img/xgsddl.jpg','所选故事可谓最经典、最深刻、引用范围最广泛，。阅读本书，让你在获得智慧的同时，领悟到快乐的人生直谛！ '),
...
(2,1,'平凡的世界','路遥',25,100,500,'img/pfdsj.jpg','作者在近十年间广阔背景上，通过复杂的矛盾纠葛，刻划了社会各阶层众多普通人的形象。'),
...
(2,1,'反映了灵魂最深层的需要','露易丝·格丽克、柳向阳、范静哗',50,200,333,'img/zdsxfyllhzscdxy.jpg','《直到世界反映了灵魂最深层的需要》完整收录了格丽克的《阿弗尔诺》（新英格兰笔会奖）和《村居生活》（格林芬诗歌奖短名单）两本诗集；'),
...
(2,1,'慈禧私生活回忆录','裕德龄、郝金茹',10,100,100,'img/zxth.jpg','作者裕德龄凭着自己与太后朝夕相处的亲身经历向读者详尽披露了慈禧太后的私生活'),
...
(2,1,'终极人生智慧之书','周国平、星云大师、杨先放、康书月、索达吉堪布、戴维·尼文',10,100,100,'img/zszjrszfzs.jpg','本套书包含：《我们都是孤独的行路人》、《每个生命都要结伴而行》等'),
...
(9,1,'海青拿天鹅唯美甜宠系列','海青拿天鹅',10,100,100,'img/gqhqntewm.jpg','古言大神海青拿天鹅5部唯美甜宠经典代表作，分别讲述了5个不同时代的爱情故事。“白芍”：上古时期天庭第一风流神君PK史上最萌天狗。'),
